...
- Monetization (experiment): Q1 free → Google signup gate before Q2 → 5 free total (`FREE_LIMIT=5` in `arya-chat.tsx`) → paywall. Packs: `PACKS` = ₹10/10q, ₹20/30q (default), ₹30/50q. `asked_count` persisted in localStorage.
